...
ActiveRecord::Schema[7.0].define(version: 2021_04_07_103150) do
  ...
  create_table "servers", force: :cascade do |t|
    ...
    t.datetime "last_synchronized_at", precision: nil
    t.string "authorized_keys_file", default: "authorized_keys"
  end
